...
import (
	...
	logredis "github.com/gitsrc/ipfs-nosql-frame/utils/logrusrchook"
...
var (
	logNameList = map[string]string{ //日志分类
		...
		LogNameLogProxy: LogNameLogProxy,
	}
...
func loggerInit() error {
	...
	if strings.ToLower(logConfig.Log.OutPut) == "stdout" {
		...
		hookConfig := logredis.HookConfig{
			...
			RedisCluster: logConfig.Log.RedisCluster,
			Format:       "origin",
		}
	...
	Fields = logrus.Fields{
		fieldAppName:       logConfig.App.AppName,
		fieldAppID:         logConfig.App.AppID,
		fieldAppVersion:    logConfig.App.AppVersion,
