...
import (
	...
	"github.com/gitsrc/ipfs-nosql-frame/utils/resparse/bufio2"
	"github.com/gitsrc/ipfs-nosql-frame/utils/resparse/errors"
)
...
func newConnDecoder(conn *Conn, bufsize int) *Decoder {
	...
	return NewDecoderBuffer(bufio2.NewReaderBuffer(r, []byte{}))
}
...
func newConnEncoder(conn *Conn, bufsize int) *Encoder {
	...
	return NewEncoderBuffer(bufio2.NewWriterBuffer(w, []byte{}))
}
